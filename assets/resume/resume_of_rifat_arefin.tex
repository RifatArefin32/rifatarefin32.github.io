...
\resumeSubHeadingListStart
    ...
    {January, 2024}
    {
        The objective of the research work is to classify different stages 
        of Alzheimer's Disease from structural MRI using CNN based model. 
        This research work has been published in the International Conference 
        on Computing Advancements (ICCA), 2024.
    }
\resumeSubHeadingListEnd
